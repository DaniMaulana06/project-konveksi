...
<div class="container-fluid mt-2">
    ...
    <div class="card-header bg-white shadow-sm px-4 py-2 rounded-4 mb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="/owner/order" wire:navigate class="btn btn-outline-primary me-2">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="info-item">
                                    <label class="text-muted small mb-1">
                                        <i class="fas fa-calendar me-1"></i>Terakhir Diedit
                                    </label>
                                    <p class="fw-semibold mb-0">
                                        {{ $order->updated_at->format('d M Y') }}
                                        <small class="text-muted ms-2">{{ $order->updated_at->format('H:i') }} WIB</small>
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <p class="fw-semibold mb-0">{{ $order->keterangan }}</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
